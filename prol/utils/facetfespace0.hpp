 ...
 */
#ifndef FACET_FESPACE0_HPP
#define FACET_FESPACE0_HPP

namespace ngcomp
{

  class NGS_DLL_HEADER FacetFESpace0 : public FESpace 
  {
  protected:  
    // Level
    int level;
  ...
  public:
    ///
    FacetFESpace0 (shared_ptr<MeshAccess> ama, const Flags & flags, bool parseflags=false);
    ///
    virtual ~FacetFESpace0 ();
    static DocInfo GetDocu();
    ///
    virtual string GetClassName () const override
    {
      return "FacetFESpace0";
    }
